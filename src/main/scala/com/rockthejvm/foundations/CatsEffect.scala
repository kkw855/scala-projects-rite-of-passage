...
//noinspection ScalaWeakerAccess,TypeAnnotation,DuplicatedCode
object CatsEffect extends IOApp.Simple {
  ...
  // Async = ability to suspend asynchronous computation (i.e. on other thread pools) into an effect managed by CEEE
