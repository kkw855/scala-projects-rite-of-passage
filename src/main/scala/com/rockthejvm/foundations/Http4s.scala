...
object Http4s extends IOApp.Simple {
  ...
  object CourseRepository {
    ...
    private val catsEffectCourse = Course(
      "9d2d75aa-2d59-468e-befd-bbfd6f4d89e1",
  ...
  // GET localhost:8080/courses/9d2d75aa-2d59-468e-befd-bbfd6f4d89e1/students
  ...
  def allRoutes[F[_]: Monad]: HttpRoutes[F] = courseRoutes <+> healthEndpoint[F]
